    ...
    >
      ...
      >
        {({ isEntering, isExiting }) => (
          <div
            className={cx(
              "z-50 flex max-w-xs origin-(--trigger-anchor-point) flex-col items-start gap-1 rounded-md bg-brand-600 px-3 shadow-lg will-change-transform",
          ...
          >
            ...
            {description && (
              <span className="text-xs font-medium text-slate-200">{description}</span>
            )}
            ...
            {arrow && (
              <AriaOverlayArrow>
                <svg
                  aria-hidden="true"
                  viewBox="0 0 100 100"
                  className="size-2.5 fill-brand-600 in-placement-left:-rotate-90 in-placement-right:rotate-90 in-placement-top:rotate-0 in-placement-bottom:rotate-180"
                >
